...
mod tests {
    ...
    fn test_azolla_error_variants() {
        ...
        assert_eq!(invalid_config.to_string(), "Invalid configuration: Invalid config");
        assert_eq!(timeout_error.to_string(), "Timeout waiting for task completion");
    }
    ...
    fn test_task_error_display() {
        ...
        assert_eq!(execution_failed.to_string(), "ExecutionError: runtime error");
    }
    ...
    fn test_error_formatting() {
        ...
        assert_eq!(buffer, "Error occurred: Connection error: Connection refused");
    }
