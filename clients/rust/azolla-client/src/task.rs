...
mod tests {
    ...
    fn test_parse_args_single() {
        ...
        let result = SimpleTask::parse_args(single_args);
    ...
    fn test_parse_args_multiple() {
        ...
        let result = MultiArgsTask::parse_args(multi_args);
    ...
    fn test_parse_args_invalid_single() {
        ...
        let result = SimpleTask::parse_args(invalid_args);
    ...
    fn test_parse_args_no_args_for_required() {
        let no_args = vec![];
        let result = SimpleTask::parse_args(no_args);
